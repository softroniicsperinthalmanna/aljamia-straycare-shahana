<?php
include 'connect.php';
$sql = mysqli_query($con, "SELECT * from register_tb inner join userlogin on register_tb.log_id=userlogin.log_id");
?>
    ...
    <main>
        ...
        <section class="rgt-ctnr">
            ...
            <section class="dashboard">
                <ul class="dash-btns">
                    <li>
                        <a href="profile-edit.html" class="active">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="user-profile.php?id=<?php echo $row['log_id'] ?>">
                                                <i class="feather" id="plus" data-feather="eye"></i>
                                                <span class="links_name" id="plus">View</span>
                                            </a>&nbsp;
                                            <a href="profile-edit.html">
