...
var diedOn;
  ...
  var image;
  var status;
  FosteringDetailPage({Key? key,required this.diedOn,required this.image,required this.animal,required this.desc,required this.gender,required this.loc,required this.breed,required this.color,required this.status}) : super(key: key);
