...
class ToAdoptDetailPage extends StatefulWidget {
  ...
  ToAdoptDetailPage({Key? key,required this.uid,required this.image,required this.animalID,required this.officeId,required this.animal,required this.desc,required this.gender,required this.loc,required this.breed,required this.color}) : super(key: key);
