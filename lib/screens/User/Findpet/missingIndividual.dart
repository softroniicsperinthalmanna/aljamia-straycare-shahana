          ...
          child: Padding(
            ...
            child: ListView(
              children: [
                Center(
                  child: Card(
                    ...
                    child: Container(
                        ...
                        child: Image(
                          image: NetworkImage(
                              '${Con.url}missingCase/${widget.image}'),
                          fit: BoxFit.cover,
                        )),
                  ),
                ),
                ...
                Text('If you find the pet ,please call the reporter below',style: GoogleFonts.poppins(color:Colors.green),),
                Align(
                  ...
                  child: Container(
                    ...
                    height: 60,
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(60), color: vio),
                    child: ListTile(
                      onTap: () {
                        Uri launchUri = Uri(scheme: 'tel', path: '9072064411');
                        launchUrl(launchUri);
